    ...
    try:
        ...
        for letter in message:
            if letter == " ":
                ...
                s_letter.append(alphabet[(alphabet.index(letter)) + shift])
            else:
                s_letter.append(alphabet[((alphabet.index(letter)) + shift) % 26])
    
        return ''.join(s_letter)
    
    except:
        print ("message should contain a string of uppercase English letters and spaces and shift is supposed to be an integer")
